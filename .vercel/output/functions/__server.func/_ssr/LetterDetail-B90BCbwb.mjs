...
import { u as VOWEL_LETTERS } from "./router-ByjMqvw8.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/LetterDetail-B90BCbwb.js
...
var LEXICON = {
	A: {
		...
		essence: "A is the first step spoken aloud. It names the appetite to become, the upright beginning that will not stay small.",
		...
		challenge: "Aspiration without choosing becomes restlessness. The invitation is to let appetite become a single, kept vow.",
	...
	B: {
		...
		essence: "B is the letter that holds. It gathers what would scatter and makes a home of two things that chose each other.",
		...
		challenge: "Binding can become enclosure. The invitation is to hold without gripping, to belong without disappearing.",
	...
	C: {
		...
		essence: "C is the spark that will not leave a still room still. It is curiosity with a match in its hand.",
		...
		challenge: "Catalysis without patience can burn the very thing it meant to awaken. Change needs a vessel.",
	...
	D: {
		...
		essence: "D is the descent. It prefers the root to the blossom, the kept practice to the bright announcement.",
		...
		challenge: "Depth can become a well with no ladder. The invitation is to bring something back to the surface.",
	...
	E: {
		...
		essence: "E is the opening of the ribcage. It is the letter that says there is more room than you were using.",
		...
		challenge: "Expansion without a shoreline becomes diffusion. Emergence still needs a shape.",
	...
	F: {
		...
		essence: "F is the open gate and the chosen path through it. Freedom here is not escape; it is uncoerced attention.",
		...
		challenge: "Freedom without fidelity is only weather. The invitation is to choose, and then stay freely.",
	...
	G: {
		...
		essence: "G is the green fact: what is tended increases. It is growth with roots, not merely accumulation.",
		...
		challenge: "Growth that never winters becomes exhaustion. Grace includes the fallow field.",
	...
	H: {
		...
		essence: "H is the far line that organizes the walk. It is hope with a backbone, and a door left unlatched.",
		...
		challenge: "Horizon-gazing can neglect the ground underfoot. Hospitality begins with the nearest person.",
	...
	I: {
		...
		essence: "I is the inner lamp. It is the letter of the solitary yes — insight before applause.",
		...
		challenge: "Interiority can become a locked study. Illumination is meant, eventually, to fall on a shared table.",
	...
	J: {
		...
		essence: "J is the road that thinks. It is motion with a conscience — joy that does not look away.",
		...
		challenge: "The journey can become a refusal to arrive. Judgment needs a place to set its pack down.",
	...
	K: {
		...
		essence: "K is the key left on the table for one's people. It is knowledge that wants to be useful to someone named.",
		...
		challenge: "Kinship can become a closed room. The key is also meant for the stranger who knocks.",
	...
	L: {
		...
		essence: "L is light that has chosen a person. It is love as a form of leadership: the willingness to go first in warmth.",
		...
		challenge: "Luminosity can perform brightness and hide fatigue. Love that leads must also rest.",
	...
	M: {
		...
		essence: "M is mass in motion. It is the letter of the practice that has begun to carry itself.",
		...
		challenge: "Momentum can outrun meaning. The invitation is to pause without losing the current.",
	...
	N: {
		...
		essence: "N is the hand that notices before it fixes. It is nurture as a form of nobility — care without condescension.",
		...
		challenge: "Nurture can forget the nurturer. Novelty for its own sake can abandon what was just beginning to root.",
	...
	O: {
		...
		essence: "O is the circle that does not close against the world. It is origin and opportunity in the same breath.",
	...
	P: {
		...
		essence: "P is the point of the spear and the patience to carve it. Purpose here is presence with a direction.",
	...
	Q: {
		...
		essence: "Q is the rare letter of the real question. It prefers quiet quality to a crowded answer.",
		...
		challenge: "The quest can despise the ordinary day. Quiet is not the same as withdrawal from the living.",
	...
	R: {
		...
		essence: "R is the sounding board. It is the letter that answers vibration with a truer tone.",
	...
	S: {
		...
		essence: "S is the braid. It is strength that comes from things agreeing to be more together than apart.",
		...
		challenge: "Synergy can dissolve the self into the braid. Synthesis still needs a name that is yours.",
	...
	T: {
		...
		essence: "T is the crossing. It is truth that costs something, and the tension that makes a new shape possible.",
	...
	U: {
		...
		essence: "U is the vessel that holds difference without erasing it. Unity here includes the unique.",
	...
	V: {
		...
		essence: "V is the far-seeing that still has a pulse. Vision here is vocation with blood in it.",
		...
		challenge: "Vision can refuse the humble near. Vulnerability is what keeps vocation from becoming a statue.",
	...
	W: {
		...
		essence: "W is the open eye that has not agreed to be bored. Wonder is wisdom before it hardens into advice.",
		...
		challenge: "Wonder can float above the will to act. Witnessing is not always enough; some looms need a hand.",
	...
	X: {
		...
		essence: "X is the mark at the margin. It is the rare letter of the crossing, the unknown variable, the life that will not stay inside the lines.",
		...
		challenge: "The edge can become exile as a habit. Crossing is a journey; it is not a permanent address.",
	...
	Y: {
		...
		essence: "Y is the fork that can still bend. It is yearning that has learned the word yes — and the word not-yet.",
		...
		challenge: "Yielding can postpone a necessary stand. Yearning needs, eventually, a chosen direction.",
	...
	Z: {
		...
		essence: "Z is the last letter and the high point. It is zeal that has been distilled — intensity without waste.",
		...
		challenge: "The zenith is a place to visit. Living only at the peak starves the climb, and the descent.",
...
function themeOf(letter) {
	return LEXICON[letter] ?? LEXICON.X;
}
function findTension(a, b) {
	return TENSIONS.find((t) => t.a === a && t.b === b || t.a === b && t.b === a);
}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: theme.keywords.join(" · ")
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-4 text-[1.05rem] leading-relaxed text-ink",
				children: theme.essence
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mt-5 grid gap-4 sm:grid-cols-2",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-sm leading-relaxed text-ink/85",
					children: theme.inner
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-sm leading-relaxed text-ink/85",
					children: theme.outer
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-5 border-t border-ink/10 pt-4 text-sm leading-relaxed text-muted",
				children: theme.invitation
			})
		]
	});
}
//#endregion
export { findTension as n, themeOf as r, LetterDetail as t };
