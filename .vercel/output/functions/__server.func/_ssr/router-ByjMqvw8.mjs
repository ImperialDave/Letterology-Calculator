...
//#region node_modules/.nitro/vite/services/ssr/assets/types--VQilCz_.js
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-ByjMqvw8.js
...
var styles_default = "/assets/styles-D6KyKDRo.css";
var APP_NAME = "Letterology";
var Route$4 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "A Letterological Horoscope engine. Enter a name and read the letter-fields it carries."
			},
			{
	...
	component: () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("html", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", {
			className: "paper-field min-h-dvh text-fg",
			children: [
...
var $$splitComponentImporter$2 = () => import("./routes-CLX0dJ5S.mjs");
var Route$3 = createFileRoute("/")({
	validateSearch: (search) => ({ name: typeof search.name === "string" ? search.name : void 0 }),
	component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
var $$splitComponentImporter$1 = () => import("./atlas-T4TAaTvr.mjs");
var Route$2 = createFileRoute("/atlas")({
	validateSearch: (search) => {
		const raw = typeof search.letter === "string" ? search.letter.toUpperCase() : "A";
		return { letter: ALPHABET.includes(raw) ? raw : "A" };
	},
	component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
var $$splitComponentImporter = () => import("./login-DOphQSLJ.mjs");
...
//#endregion
export { getBaseURL as a, ALPHABET as c, PACKAGE_VERSION as i, MAJOR_FIELDS as l, GROK_PROVIDERS as n, Route$2 as o, GENERIC_OAUTH_ERROR_CODES as r, Route$3 as s, router_exports as t, VOWEL_LETTERS as u };
