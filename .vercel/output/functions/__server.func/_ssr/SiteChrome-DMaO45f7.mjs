...
import { a as getBaseURL, i as PACKAGE_VERSION, r as GENERIC_OAUTH_ERROR_CODES } from "./router-ByjMqvw8.mjs";
import { i as atom, n as onMount, r as onSet, t as listenKeys } from "../_libs/nanostores.mjs";
import { n as clsx } from "../_libs/class-variance-authority+clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/SiteChrome-DMaO45f7.js
...
function AuthSlot() {
	...
	if (isPending) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "h-9 w-16 rounded-md bg-ink/10",
		"aria-hidden": "true"
	});
	if (user) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SignedIn, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserButton, {}) });
...
function SiteHeader({ current }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mx-auto flex h-16 max-w-5xl items-center justify-between gap-4 px-4 sm:px-6",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
					...
					className: "truncate font-display text-lg tracking-[0.04em] text-ink",
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						to: "/",
						className: cn("inline-flex h-9 items-center rounded-md px-3 font-display text-xs tracking-[0.14em] uppercase", current === "read" ? "text-ink" : "text-muted hover:text-ink"),
						children: "Reading"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						to: "/atlas",
						className: cn("inline-flex h-9 items-center rounded-md px-3 font-display text-xs tracking-[0.14em] uppercase", current === "atlas" ? "text-ink" : "text-muted hover:text-ink"),
						children: "Atlas"
					}),
...
function SiteFooter() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "mx-auto max-w-5xl px-4 py-8 text-center text-sm text-muted sm:px-6",
			children: "A contemplative practice, not a prediction. Names are read as constellations of letter-fields."
		})
	});
}
//#endregion
export { signIn as i, SiteHeader as n, cn as r, SiteFooter as t };
