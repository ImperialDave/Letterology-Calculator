...
const BRUSHES: Brush[] = [
  ...
  { ch: "l", group: "hazard", label: "Censer — swings" },
  { ch: "z", group: "hazard", label: "Stamper — slams" },
  { ch: "x", group: "hazard", label: "Guillotine — shoots" },
  { ch: "j", group: "hazard", label: "Grate — burns" },
  { ch: "d", group: "hazard", label: "Rotor — flips" },
  { ch: "w", group: "hazard", label: "Sinkink — swallows" },
  { ch: "}", group: "hazard", label: "Shutter — opens" },
  { ch: "[", group: "hazard", label: "Echo — delayed blast" },
  ...
  { ch: "f", group: "mover", label: "Drop-cap — falls, then floor" },
  { ch: "{", group: "mover", label: "Carriage — rides" },
