...
export const LORE: Record<LoreId, LoreDef> = {
  e: {
    ...
    lines: [
      ...
      "The first five districts have their own numbered doors. After that, Continue is the only gate that keeps opening new ledgers, all the way to 60. Replay only repeats the last page you closed.",
  ...
  t: {
    ...
    lines: [
      ...
      "Later stages starve your ink on purpose. Pick up every drop. After the first five, only the Continue door keeps writing new pages through 60.",
  ...
  n: {
    ...
    lines: [
      ...
      "The Continue gate in the hub is the only door that keeps offering new ledgers until 60. Replay only reopens the last page you closed. The numbered doors stay on the first five.",
  ...
  d: {
    ...
    lines: [
      ...
      "The hub has milestone doors for the first five districts. Continue is the only door that keeps opening new ledgers through 60. Replay only reopens the last one you cleared.",
      "Thirty was a period. Sixty is the remainder. If you see a gold Continue, that is the road.",
