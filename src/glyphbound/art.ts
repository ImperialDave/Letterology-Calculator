...
export const ART_MANIFEST: ArtEntry[] = [
  ...
  { kind: "hazards", name: "censer", cols: 2, rows: 4 },
  { kind: "hazards", name: "stamper", cols: 2, rows: 3 },
  { kind: "hazards", name: "guillotine", cols: 2, rows: 3 },
  { kind: "hazards", name: "grate", cols: 2, rows: 2 },
  { kind: "hazards", name: "rotor", cols: 2, rows: 4 },
  { kind: "hazards", name: "sinkink", cols: 2, rows: 3 },
  { kind: "hazards", name: "shutter", cols: 2, rows: 2 },
  { kind: "hazards", name: "echo", cols: 2, rows: 2 },
  { kind: "movers", name: "shelf" },
  { kind: "movers", name: "dropcap", cols: 2, rows: 4 },
  { kind: "movers", name: "carriage", cols: 2, rows: 3 },
