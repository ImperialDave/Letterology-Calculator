...
export const BEATS: Record<string, Beat[]> = {
  ...
  ice: [
    ...
    { id: 5, when: "arena", t: 0.9, kind: "radio", who: "s", text: "Kite. Dualis froze a sail. Clip a wing, then the keel." },
    { id: 6, when: "arena", t: 1.1, kind: "spawn", ships: [{ kind: "mech", dx: 0, dy: 24, dz: -160, setPiece: true }] },
    { id: 7, when: "arena", t: 7.6, kind: "radio", who: "s", text: "Serifs. His proofreaders. They drop from the bays." },
    { id: 8, when: "arena", t: 8, kind: "spawn", ships: [{ kind: "ace", dx: -40, dy: 12, dz: -160 }, { kind: "ace", dx: 40, dy: 12, dz: -160 }, { kind: "ace", dx: 0, dy: 16, dz: -200 }] },
