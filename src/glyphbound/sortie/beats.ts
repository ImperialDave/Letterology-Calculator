...
export const BEATS: Record<string, Beat[]> = {
  coast: [
    ...
    { id: 6, when: "rail", t: 0.18, kind: "spawn", ships: [{ kind: "fighter", dx: -12, dy: 6, dz: -40 }, { kind: "fighter", dx: 12, dy: 6, dz: -40 }] },
    ...
    { id: 9, when: "rail", t: 0.3, kind: "spawn", ships: V(-44, 22) },
    { id: 10, when: "rail", t: 0.34, kind: "spawn", ships: [{ kind: "mech", dx: -40, dy: -8, dz: -50, hp: 6 }, { kind: "mech", dx: 40, dy: -8, dz: -70, hp: 6 }] },
    { id: 11, when: "rail", t: 0.38, kind: "spawn", ships: [{ kind: "fighter", dx: 0, dy: 10, dz: -36 }, { kind: "cork", dx: 30, dy: 12, dz: -55 }] },
    { id: 12, when: "rail", t: 0.42, kind: "pickup", loot: { kind: "stem", dx: -8, dy: 4, dz: -20 } },
    { id: 13, when: "rail", t: 0.48, kind: "check", who: "e", text: "Checkpoint. s is jumped — cut them." },
    { id: 14, when: "rail", t: 0.5, kind: "spawn", ships: [{ kind: "fighter", dx: -20, dy: 4, dz: -30 }, { kind: "fighter", dx: 0, dy: 6, dz: -38 }, { kind: "fighter", dx: 20, dy: 4, dz: -30 }] },
    { id: 15, when: "rail", t: 0.55, kind: "radio", who: "s", text: "Seven n-arches. Follow the water." },
    { id: 16, when: "rail", t: 0.58, kind: "spawn", ships: [{ kind: "fighter", dx: 24, dy: 8, dz: -40 }, { kind: "fighter", dx: -24, dy: 8, dz: -52 }] },
    { id: 17, when: "rail", t: 0.64, kind: "pickup", loot: { kind: "gold", dx: 0, dy: 2, dz: -20 } },
    { id: 18, when: "rail", t: 0.68, kind: "spawn", ships: [{ kind: "bomber", dx: 0, dy: 18, dz: -48 }, { kind: "cork", dx: 32, dy: 10, dz: -36 }] },
    { id: 19, when: "rail", t: 0.74, kind: "radio", who: "b", text: "Dip the lintel if you want the gorge." },
    { id: 20, when: "rail", t: 0.8, kind: "spawn", ships: [{ kind: "bomber", dx: -16, dy: 14, dz: -40 }, { kind: "bomber", dx: 16, dy: 14, dz: -40 }] },
    { id: 21, when: "rail", t: 0.88, kind: "spawn", ships: V(-42, 20) },
    { id: 22, when: "arena", t: 0.4, kind: "radio", who: "s", text: "Scale on the plaza. Knees, then frill, then core." },
    { id: 23, when: "arena", t: 0.6, kind: "spawn", ships: [{ kind: "fighter", dx: -50, dy: 8, dz: -40 }, { kind: "fighter", dx: 50, dy: 8, dz: -40 }, { kind: "mech", dx: 0, dy: -20, dz: -160, hp: 24 }] },
  ],
  slug: [
