...
const JOINTS: JointDef[] = [
  { id: "platen", parent: null, bind: { x: 0, y: 32, z: 0 } },
  ...
  { id: "kneeL", parent: "hipL", bind: { x: 0, y: -14, z: 0 } },
  { id: "ankleL", parent: "kneeL", bind: { x: 0, y: -12, z: 0 } },
  { id: "footL", parent: "ankleL", bind: { x: 0, y: -6, z: 5 } },
  { id: "hipR", parent: "platen", bind: { x: 11, y: -4, z: 0 } },
  { id: "kneeR", parent: "hipR", bind: { x: 0, y: -14, z: 0 } },
  { id: "ankleR", parent: "kneeR", bind: { x: 0, y: -12, z: 0 } },
  { id: "footR", parent: "ankleR", bind: { x: 0, y: -6, z: 5 } },
