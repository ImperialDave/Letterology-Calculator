...
export const VOICE = {
  ...
  glyphLede:
    "Play as the letter c against living numbers. Five closed chapters, then the Numberomicons. One hundred sixty ledgers.",
  ...
  rollSignIn: "Sign in to open the court",
  courtTitle: "The Court",
  courtLede:
    "Tools for the named address. Portraits, threshold readings, and membership marks. None of this leaves this room.",
