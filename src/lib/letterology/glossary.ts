...
export const GLOSSARY: GlossEntry[] = [
  {
    id: "letter-brained",
    term: "Letter-brained",
    metaphor: "You start with the living person, then you may count.",
    plain: "A way of looking that starts with the whole living thing in front of you. Counting is allowed after that, as long as it comes back to the person.",
    opacity: "high",
    surfaces: ["brain"],
  },
  {
    id: "number-brained",
    term: "Number-brained",
    metaphor: "You start with ranks, dates, sums, and scores.",
    plain: "A way of looking that starts with pieces you can file and add up. Useful, until the pile is treated as the person.",
    opacity: "high",
    surfaces: ["brain"],
  },
  {
    id: "circuit-kept",
    term: "Circuit-kept",
    metaphor: "See the whole. Use the pieces. Come back.",
    plain: "You already go out into the count and come home to the person. That is the practice, not an indecisive tie.",
    opacity: "high",
    surfaces: ["brain"],
  },
  {
    id: "sight",
    term: "Sight",
    metaphor: "How you take a life in.",
    plain: "How you take a life in. Wonder is how long you stay with what is particular. Inquiry is how much you want the joints of a thing.",
    opacity: "high",
    surfaces: ["brain"],
  },
  {
    id: "keeping-trait",
    term: "Keeping",
    metaphor: "How you handle work and promises.",
    plain: "How you handle work and promises. Crossing is whether you finish after the shine is gone. The File is how much order you need in order to work.",
    opacity: "high",
    surfaces: ["brain"],
  },
  {
    id: "entrance",
    term: "Entrance",
    metaphor: "How you show up in a room.",
    plain: "How you show up in a room. Warmth is the heat you bring. The Role is whether you take the floor when a group stalls.",
    opacity: "high",
    surfaces: ["brain"],
  },
  {
    id: "court-trait",
    term: "Court",
    metaphor: "How you meet other people.",
    plain: "How you meet other people. Neighbor is how much their weather arrives in you. The Rule is how carefully you keep a table easy to run.",
    opacity: "high",
    surfaces: ["brain"],
  },
  {
    id: "weather-trait",
    term: "Weather",
    metaphor: "How you treat a hard day.",
    plain: "How you treat a hard day. The Contrary is whether you go small. The Storm is how loudly a setback runs through you.",
    opacity: "high",
    surfaces: ["brain"],
  },
  {
  ...
  },
  {
    id: "whole",
    term: "Whole",
    metaphor: "The username as one living thing.",
    plain: "The username, the day, or the act you will stand behind. House, manner, and field are seats inside that person. They do not get added into a new identity.",
    opacity: "high",
    surfaces: ["why"],
  },
  {
    id: "piece",
    term: "Piece",
    metaphor: "One letter, held by itself.",
    plain: "One letter, one date, one total, one score. Useful. Not the portrait. The count helps, and then it has to come home.",
    opacity: "high",
    surfaces: ["why"],
  },
  {
    id: "return",
    term: "Return",
    metaphor: "The count has to come home.",
    plain: "After you count something, look back at the person or the story it came from. The count helps. It does not replace the thing you counted.",
    opacity: "high",
    surfaces: ["why"],
  },
  {
    id: "master-emissary",
    term: "Master and Emissary",
    metaphor: "A good servant. A bad king.",
    plain: "Two ways of looking at the same life. One sees the whole person. The other sees separate facts and measurements. The second was meant to serve the first.",
    opacity: "low",
    surfaces: ["why"],
  },
  {
