...
export const GLOSSARY: GlossEntry[] = [
  ...
  },
  {
    ...
    plain: "Whether you stay with the living thing long enough to see it, or reach for a category before it has finished arriving.",
    opacity: "high",
    surfaces: ["brain"],
  },
  {
    ...
    plain: "Whether you finish a crossing, or tidy the file so neatly that nothing living has to move.",
    opacity: "high",
    surfaces: ["brain"],
  },
  {
    ...
    plain: "Whether you arrive as a person, or as a rank, title, or performance of being first.",
    opacity: "high",
    surfaces: ["brain"],
  },
  {
    ...
    plain: "Whether you meet a neighbor, including the ones who keep you honest, or a type you can sort.",
    opacity: "high",
    surfaces: ["brain"],
  },
  {
    ...
    plain: "Whether a low day is weather you can work with, or a verdict on your worth.",
    opacity: "high",
    surfaces: ["brain"],
  },
  {
